...
/**
 * @file az_iot_provisioning_v2_client.h
 *
 * @brief Definition for the Azure Device Provisioning v2 client.
 * @remark The Device Provisioning v2 MQTT protocol is described at
...
#ifndef _az_IOT_PROVISIONING_V2_CLIENT_H
#define _az_IOT_PROVISIONING_V2_CLIENT_H
...
typedef struct
{
   ...
   */
  az_span user_agent;
} az_iot_provisioning_v2_client_options;

/**
 * @brief Azure IoT Provisioning v2 Client.
 *
 */
typedef struct
{
  struct
  {
    ...
    az_iot_provisioning_v2_client_options options;
  } _internal;
} az_iot_provisioning_v2_client;

/**
 * @brief Gets the default Azure IoT Provisioning v2 Client options.
 *
 * Call this to obtain an initialized #az_iot_provisioning_v2_client_options structure that
 * can be afterwards modified and passed to az_iot_provisioning_v2_client_init().
 *
 * @return #az_iot_provisioning_v2_client_options.
 */
 ...
 *
 * @param[in] client The #az_iot_provisioning_v2_client to use for this call.
 ...
 * @param[in] options __[nullable]__ A reference to an #az_iot_provisioning_v2_client_options
 ...
 *
 *   The TPM Asymmetric Device Provisioning v2 protocol is not supported on the MQTT protocol. TPMs can
 ...
 * @retval #AZ_ERROR_NOT_ENOUGH_SPACE The buffer is too small.
 */
AZ_NODISCARD az_result az_iot_provisioning_v2_client_sas_get_signature(
    az_iot_provisioning_v2_client const* client,
 ...
 * @retval #AZ_ERROR_NOT_ENOUGH_SPACE The buffer is too small.
 */
AZ_NODISCARD az_result az_iot_provisioning_v2_client_sas_get_password(
    az_iot_provisioning_v2_client const* client,
...
} az_iot_provisioning_v2_client_registration_state;

/**
 * @brief Azure IoT Provisioning v2 Service operation status.
 *
 */
typedef enum
{
...
} az_iot_provisioning_v2_client_operation_status;
...
typedef struct
{
   ...
   */
  az_iot_provisioning_v2_client_operation_status operation_status;
   ...
   */
  az_iot_provisioning_v2_client_registration_state registration_state;
} az_iot_provisioning_v2_client_register_response;
 ...
 */
AZ_INLINE bool az_iot_provisioning_v2_client_operation_complete(
    az_iot_provisioning_v2_client_operation_status operation_status)
{
  return (operation_status > AZ_IOT_PROVISIONING_V2_STATUS_ASSIGNING);
}
 ...
 * to the [Provisioning v2 Service's Device Registration document]
...
/**
 * @brief Azure IoT Provisioning v2 Client options for
 * az_iot_provisioning_v2_client_get_request_payload(). Not currently used.  Reserved for future use.
 *
 */
typedef struct
{
...
} az_iot_provisioning_v2_client_payload_options;

/**
 * @brief Builds the optional payload for a provisioning v2 request.
...
#endif // _az_IOT_PROVISIONING_V2_CLIENT_H
