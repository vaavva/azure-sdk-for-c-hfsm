...
extern "C"
{
    ...
    #define OPTION_RETRY_INTERVAL_SEC "retry_interval_sec";
...
#define OPTION_X509_PRIVATE_KEY_DEF
    ...
    #define OPTION_CONNECTION_TIMEOUT "connect_timeout"
    ...
    #define OPTION_PROXY_HOST "proxy_address"
    #define OPTION_PROXY_USERNAME "proxy_username"
    #define OPTION_PROXY_PASSWORD "proxy_password"
    ...
    #define OPTION_BLOB_UPLOAD_TIMEOUT_SECS "blob_upload_timeout_secs"
    ...
    */
    #define OPTION_NETWORK_INTERFACE_UPLOAD_TO_BLOB "network_interface_upload_to_blob"
    #define OPTION_PRODUCT_INFO "product_info"

    #define OPTION_BLOB_UPLOAD_TLS_RENEGOTIATION "blob_upload_tls_renegotiation"
    ...
    */
    #define OPTION_SERVICE_SIDE_KEEP_ALIVE_FREQ_SECS "svc2cl_keep_alive_timeout_secs"
    ...
    */
    #define OPTION_REMOTE_IDLE_TIMEOUT_RATIO "cl2svc_keep_alive_send_ratio"
    ...
    */
    ...
    #define OPTION_DIAGNOSTIC_SAMPLING_PERCENTAGE "diag_sampling_percentage"
...
// In all these cases the failures are cumulatively counted; if the count is equal to or greater than DEVICE_FAILURE_COUNT_RECONNECTION_THRESHOLD
