...
az_result az_iot_hub_methods_handle(az_iot_hub_client* client, az_iot_mqtt_publish* pub_received, az_iot_method_request* method_request);
...
az_result az_iot_hub_methods_create_response(az_iot_hub_client* client, az_iot_method_response* response, az_iot_mqtt_publish *mqtt_pub);
