...
int main(int argc, char* argv[])
{
  ...
  LOG_AND_EXIT_IF_FAILED(az_rpc_server_init(&unlock_rpc_server, &mqtt_connection, &unlock_rpc_server_memory, model_id, client_id, unlock_command_name, NULL));
  ...
  LOG_AND_EXIT_IF_FAILED(az_rpc_server_init(&getstats_rpc_server, &mqtt_connection, &getstats_rpc_server_memory, model_id, client_id, getstats_command_name, NULL));
