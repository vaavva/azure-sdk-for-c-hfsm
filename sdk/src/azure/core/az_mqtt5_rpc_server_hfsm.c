...
static az_result waiting(az_event_policy* me, az_event event)
{
  ...
  if (_az_LOG_SHOULD_WRITE(event.type))
  {
    printf("%s ", az_span_ptr(az_span_slice_to_end(this_policy->_internal.rpc_server_memory.sub_topic, az_span_size(this_policy->_internal.rpc_server_memory.sub_topic) - 201)));
...
static az_result faulted(az_event_policy* me, az_event event)
{
  ...
  if (_az_LOG_SHOULD_WRITE(event.type))
  {
        printf("%s ", az_span_ptr(az_span_slice_to_end(((az_mqtt5_rpc_server*)me)->_internal.rpc_server_memory.sub_topic, az_span_size(((az_mqtt5_rpc_server*)me)->_internal.rpc_server_memory.sub_topic) - 201)));
