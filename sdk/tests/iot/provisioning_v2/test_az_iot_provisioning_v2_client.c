...
#include "test_az_iot_provisioning_v2_client.h"
...
static void test_az_iot_provisioning_v2_client_options_default_succeed()
{
  az_iot_provisioning_v2_client_options options = az_iot_provisioning_v2_client_options_default();
  assert_true(az_span_is_content_equal(options.user_agent, AZ_SPAN_EMPTY));
}

static void test_az_iot_provisioning_v2_client_default_options_get_connect_info_succeed()
{
  ...
  ret = az_iot_provisioning_v2_client_get_client_id(&client, client_id, sizeof(client_id), NULL);
  assert_int_equal(AZ_OK, ret);
  assert_string_equal(TEST_REGISTRATION_ID, client_id);
  assert_int_equal((uint8_t)0xCC, (uint8_t)client_id[strlen(client_id) + 1]);

  size_t client_id_len;
  ret = az_iot_provisioning_v2_client_get_client_id(
...
static void test_az_iot_provisioning_v2_client_custom_options_get_username_succeed()
{
  az_iot_provisioning_v2_client client;
  az_iot_provisioning_v2_client_options options = az_iot_provisioning_v2_client_options_default();
  ...
  char expected_username[] = TEST_ID_SCOPE
      ...
      "/api-version=" AZ_IOT_PROVISIONING_V2_SERVICE_VERSION USER_AGENT_PREFIX TEST_USER_AGENT;
...
static void test_az_iot_provisioning_v2_client_get_connect_info_insufficient_space_fails()
{
  az_iot_provisioning_v2_client client;
  az_iot_provisioning_v2_client_options options = az_iot_provisioning_v2_client_options_default();
  options.user_agent = AZ_SPAN_FROM_STR(TEST_USER_AGENT);
...
static void test_az_iot_provisioning_v2_client_get_register_publish_topic_succeed()
{
  ...
  ret = az_iot_provisioning_v2_client_register_get_publish_topic(&client, topic, sizeof(topic), NULL);
  ...
  size_t topic_len;
  ret = az_iot_provisioning_v2_client_register_get_publish_topic(
...
static void test_az_iot_provisioning_v2_client_get_register_publish_topic_insufficient_space_fails()
{
  az_iot_provisioning_v2_client client = { 0 };
  az_result ret = az_iot_provisioning_v2_client_init(
      &client,
...
static void test_az_iot_provisioning_v2_client_get_operation_status_publish_topic_succeed()
{
  az_iot_provisioning_v2_client client = { 0 };
  az_result ret = az_iot_provisioning_v2_client_init(
      &client,
  ...
  az_iot_provisioning_v2_client_register_response response = { 0 };
  response.operation_id = operation_id;

  ret = az_iot_provisioning_v2_client_query_status_get_publish_topic(
...
static void
test_az_iot_provisioning_v2_client_get_operation_status_publish_topic_insufficient_space_fails()
{
  az_iot_provisioning_v2_client client = { 0 };
  az_result ret = az_iot_provisioning_v2_client_init(
      &client,
...
int test_az_iot_provisioning_v2_client()
{
  const struct CMUnitTest tests[] = {
    cmocka_unit_test(test_az_iot_provisioning_v2_client_options_default_succeed),
    cmocka_unit_test(test_az_iot_provisioning_v2_client_default_options_get_connect_info_succeed),
    cmocka_unit_test(test_az_iot_provisioning_v2_client_custom_options_get_username_succeed),
    cmocka_unit_test(test_az_iot_provisioning_v2_client_get_connect_info_insufficient_space_fails),
    cmocka_unit_test(test_az_iot_provisioning_v2_client_get_register_publish_topic_succeed),
    cmocka_unit_test(
        test_az_iot_provisioning_v2_client_get_register_publish_topic_insufficient_space_fails),
    cmocka_unit_test(test_az_iot_provisioning_v2_client_get_operation_status_publish_topic_succeed),
    cmocka_unit_test(
        test_az_iot_provisioning_v2_client_get_operation_status_publish_topic_insufficient_space_fails),
  };

  return cmocka_run_group_tests_name("az_iot_provisioning_v2_client", tests, NULL, NULL);
}
